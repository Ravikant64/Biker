angular.module('treeniApp.project').controller( 'ProjectShowBudgetCtrl', [
  '$scope',
  '$q',
  '$stateParams',
  '$location',
  ...
  function ($scope, $q, $stateParams, $location, $modal, PathService, Auth, IndicatorDataService, ConditionService, ScoringService, Utils, ProjectService) {
    ...
    $scope.init = function () {
      ...
      $scope.new_scores = {};
      $q.all([
        IndicatorDataService.getIndicatorRecord($stateParams.id),
        ProjectService.getProjectIndicator('Budget'),
