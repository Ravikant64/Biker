( function() {
  ...
  function ProjectBudgetCtrl($scope, $location, $http, $q, $stateParams, $timeout, $log, PathService, Auth, FileUploader, IndicatorDataService, ConditionService, ProjectService, Utils, action) {
    ...
    function redirectToShow() {
      var url = PathService('budgetList', $stateParams.project_id); ////
