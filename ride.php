	...
	<body ng-app="ride">
		...
		<section class="status dark-bg dark-bg--status">
			<div class="container wow slideInRight" data-wow-delay="0.7s" data-wow-duration="1.5s">
				...
				<h2 class="title title--page"><span class="title__bold">BikerClub</span> Ride</h2>
			</div>
		</section>
	    ...
	    <!-- Angular-App-->
	    <script src="js/angular-modal/angular-modal-service.js"></script>
	    <script src="js/angular-modal/angular-modal-service.min.js"></script>
